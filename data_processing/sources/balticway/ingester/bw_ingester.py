...
from data_processing.sources.balticway.parser.models import BWYearResults
...
def load_year_results_from_dir(parsed_dir: Path) -> BWYearResults:
    ...
    from data_processing.sources.balticway.parser.bw_parser import get_parsed_filename
