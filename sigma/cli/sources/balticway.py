...
from sigma.sources.balticway.downloader import (
    AVAILABLE_YEARS,
    DownloadError,
    download_year,
)
...
class BalticWayAdapter(SourceAdapter):
    ...
    def parse_raw(
        ...
        from sigma.sources.balticway.parser import ParserError, parse_year
    ...
    def ingest(
        ...
        from sigma.sources.balticway.ingester import ingest_balticway_data
