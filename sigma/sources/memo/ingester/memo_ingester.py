...
from sigma.sources.memo.parser.models import (
    MEMOTeamYearResults,
    MEMOYearResults,
)
...
def load_year_results_from_dir(parsed_dir: Path) -> MEMOYearResults:
    ...
    from sigma.sources.memo.parser.memo_parser import get_parsed_filename
...
def load_team_year_results_from_dir(parsed_dir: Path) -> MEMOTeamYearResults:
    ...
    from sigma.sources.memo.parser.memo_team_parser import (
